...
**# Preamble
	...
	* start setting
	...
	cd "C:\Users\imahd\Dropbox\TeIAS-Thesis-STATA\1_Do"
	* globals
	global dta "../2_Data"
	global tbl "../3_Tables/v5"
	
	global vt $tbl/v5.tex
	global vt1 $tbl/v5-robust.tex
	global vt2 $tbl/v5-size.tex
	global vt3 $tbl/v5-no_news.tex
